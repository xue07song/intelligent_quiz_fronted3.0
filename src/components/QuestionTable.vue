          ...
          <tr v-for="item in list" :key="item.id">
            ...
            <td class="col-act">
              <div class="iq-table-action">
                ...
                <button v-if="isStudent" class="iq-btn iq-btn-ghost iq-btn-sm act-add" @click="$emit('add-to-my-bank', item)">📥 加入我的题库</button>
              </div>
            </td>
          </tr>
...
const emit = defineEmits(['view', 'edit', 'delete', 'add-to-my-bank', 'update:modelValue', 'selection-change']);
...
.q-table col.col-act-col { width: 150px; }
...
.act-add { color: var(--iq-state-success) !important; }
.act-add:hover:not(:disabled) { background: var(--iq-state-success-bg) !important; color: #047857 !important; }
